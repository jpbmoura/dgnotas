...
const SELECT_ALL = `
  id, empresa_id, tipo, codigo, nome, nome_fiscal, descricao, valor, status,
  plataforma, garantia,
  unidade, ncm, cest, origem, cfop,
  cst_or_csosn, aliq_icms, cst_ipi, aliq_ipi,
  ...
  async save(produto: Produto): Promise<void> {
    ...
    await this.pool.query(
      ...
      ON CONFLICT (id) DO UPDATE SET
        ...
        nome                = EXCLUDED.nome,
        nome_fiscal         = EXCLUDED.nome_fiscal,
