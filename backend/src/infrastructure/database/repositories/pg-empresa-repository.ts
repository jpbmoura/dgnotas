...
const SELECT_ALL = `
  ...
  isento_ie, inscricao_estadual, inscricao_municipal,
  cnae_principal, cnaes_secundarios,
  regime_tributario, regime_especial, status,
  ...
  email, telefone, emails_relatorios,
  ...
  async save(empresa: Empresa): Promise<void> {
    ...
    await this.pool.query(
      ...
      ON CONFLICT (id) DO UPDATE SET
        ...
        emails_relatorios       = EXCLUDED.emails_relatorios,
